...
export default function CreateIllustrationForm() {
  ...
  return (
    <form
      ...
      className="grid h-[calc(90dvh-100px)]"
    >
        ...
        <Controller
          ...
          render={({ fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="form-rhf-demo-title">Imágenes</FieldLabel>
              <Input
                id="images"
                className="hidden"
                ...
                <div className="flex flex-col gap-2 justify-between w-full">
                  ...
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Selecciona la semana gestacional" />
                    </SelectTrigger>
